...
This is the **tier-2 fallback** for `ChallengeGen.Extract`. Where that module copies verbatim
...
Auto-generated by ChallengeGen (fallback extraction). -/
...
def writeAllFlatExtractions (env : Environment) (rootPrefix : Name) (decls : Array ChallengeDecl)
